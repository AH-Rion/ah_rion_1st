...
import { Mail, Lock, Eye, EyeOff, Loader2, UserPlus, User, AlertCircle } from "lucide-react";
    ...
    <AuthLayout>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Start building professional resumes for free</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-10 pr-10 h-11 ${errors.confirm ? "border-destructive focus-visible:ring-destructive" : ""}`}
                required
                autoComplete="new-password"
              />
              <button
            ...
            {errors.confirm && <p className="text-xs text-destructive flex items-center gap-1"><AlertCircle className="h-3 w-3" /> {errors.confirm}</p>}
          </div>
