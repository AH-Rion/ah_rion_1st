  ...
  return (
    <Layout>
      ...
      <section className="hero-gradient relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,hsl(45_93%_47%/0.08),transparent_60%)]" />
        <div className="container mx-auto px-4 py-24 md:py-36 relative z-10">
          ...
          >
            ...
            <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold leading-tight text-hero-foreground">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button variant="hero" size="lg" asChild>
                <Link to="/resume">
                  Build Your Resume Free <ArrowRight className="ml-2" size={18} />
                </Link>
              </Button>
            ...
            <p className="mt-6 text-sm text-hero-muted/60">No signup required · Free forever · PDF download</p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className="p-6 rounded-xl border border-border bg-card hover:border-primary/30 transition-all duration-300 group"
              >
      ...
      <section className="hero-gradient py-24 relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,hsl(45_93%_47%/0.06),transparent_60%)]" />
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="font-display text-3xl md:text-5xl font-bold text-hero-foreground mb-4">
            Ready to land your dream job?
          </h2>
          <p className="text-hero-muted mb-8 max-w-lg mx-auto">
            Join thousands of professionals who trust our AI to build resumes that get results.
          </p>
          <Button variant="hero" size="lg" asChild>
            <Link to="/resume">Build Your Resume Now <ArrowRight className="ml-2" size={18} /></Link>
          </Button>
        </div>
      </section>
    </Layout>
